<?php
/**
 * DailyreportControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Dailyreport Module
 *
 * @category Test
 * @package Dailyreport
...
namespace OnePlaceTest\Dailyreport\Controller;

use OnePlace\Dailyreport\Controller\DailyreportController;
...
class DailyreportControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/dailyreport', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('dailyreport');
        $this->assertControllerName(DailyreportController::class); // as specified in router's controller name alias
        $this->assertControllerClass('DailyreportController');
        $this->assertMatchedRouteName('dailyreport');
    }
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/dailyreport/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('dailyreport');
        $this->assertControllerName(DailyreportController::class); // as specified in router's controller name alias
        $this->assertControllerClass('DailyreportController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/dailyreport/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('dailyreport');
        $this->assertControllerName(DailyreportController::class); // as specified in router's controller name alias
        $this->assertControllerClass('DailyreportController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/dailyreport/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('dailyreport');
        $this->assertControllerName(DailyreportController::class); // as specified in router's controller name alias
        $this->assertControllerClass('DailyreportController');
