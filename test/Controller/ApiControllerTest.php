...
use OnePlace\Dailyreport\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/dailyreport/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/dailyreport/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('dailyreport-api');
    }
}
