<?php
/**
 * Dailyreport.php - Dailyreport Entity
 *
 * Entity Model for Dailyreport
 *
 * @category Model
 * @package Dailyreport
...
class Dailyreport extends CoreEntityModel {
    public $label;
    ...
    public function exchangeArray(array $aData) {
        $this->id = !empty($aData['Dailyreport_ID']) ? $aData['Dailyreport_ID'] : 0;
